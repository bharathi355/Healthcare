  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
		...
		<li><button type="button" id="btnid2" class="btn btn-info btn-lg"><a href="#">Current Summary</a></button></li>';
		}
...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	//echo $pid." hi<br>";
	$query=mysql_query("SELECT hr,br,bp_systole,bp_diastole,ecg,spo2,time FROM summary WHERE pid='$pid' ORDER BY time DESC") or die(mysql_error());
	?>
	...
	</thead><?php if(isset($_SESSION['pid'])){
	echo '<p align="justify"><h1>Your average values</h1></p><br>';
	}
	else if(isset($_SESSION['viewprofile'])){
	echo '<p align="justify"><h1>Summary of last 10 readings for '.$_SESSION["profilename"].' </h1></p><br>';
	}?>
	<?php
		$i=0;
