  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><button type="button" class="btn btn-info btn-lg"><img src="images/logo2.png" height="35" width="75"/><a href="#"></a>Home Page</button></li>
			<li><button type="button" id="btnid" class="btn btn-info btn-lg" data-toggle="modal" data-target="#doctor"><img src="images/doclogin.png" width="75" height="35"></img>Doctor Login</button></li>
...
<div class="container-fluid text-center">    
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="carouselimg" class="carouselimg" src="images/rhc.jpg">
